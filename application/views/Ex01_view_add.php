  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-9">
          <form action="/index.php/Ex01/add" method="post">
            <?=validation_errors()?>
            <div class="form-group">
              <label for="exampleInputEmail1">Title</label>
              <input type="text" class="form-control" name="inputTitle" id="exampleInputEmail1" placeholder="Enter title">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Password</label>
              <textarea name="inputDescription" rows="15" placeholder="Enter contents" class="form-control"></textarea>
            </div>
